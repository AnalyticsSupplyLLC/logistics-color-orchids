...
class RouteStop(db.Model):
    ...
    fuel_expenses = db.Column(db.String(80))
    ...
    returned_carts = db.Column(db.String(80))
    ...
    stop_fuel = db.Column(db.String(80))
    ...
    def update(self, route_start_date,route_end_date,hotel_expenses,fuel_expenses,fuel_gallons,total_miles,
                 total_hours,operator_name,operator_pay,customer_name,ship_to,customer_zip,miles_from_company,
                 customer_cost,percent_load,pallets,carts,returned_carts,percent_of_total,stop_miles,stop_hours,
                 stop_fuel_gallons,stop_operator_pay,stop_hotel,stop_fuel,percent_freight,fuel_rate,cost_per_mile,revenue_per_mile):
        ...
        self.carts    =    carts
        self.returned_carts    =    returned_carts
        ...
        self.stop_fuel    =    stop_fuel
        self.percent_freight    =    percent_freight
        self.fuel_rate    =    fuel_rate
        self.cost_per_mile    =    cost_per_mile
        self.revenue_per_mile    =    revenue_per_mile

    def __init__(self, _id,route_start_date,route_end_date,hotel_expenses,fuel_expenses,fuel_gallons,total_miles,
                 total_hours,operator_name,operator_pay,customer_name,ship_to,customer_zip,miles_from_company,
                 customer_cost,percent_load,pallets,carts,returned_carts,percent_of_total,stop_miles,stop_hours,
                 stop_fuel_gallons,stop_operator_pay,stop_hotel,stop_fuel,percent_freight,fuel_rate,cost_per_mile,revenue_per_mile):
        self.id    =    _id
